...
import { iconPDF } from "../../../constrants/data";
    ...
    return(<Box style={{position:'relative'}}>
        {
            ...
            <Box style={{display:'flex'}}>
                ...
                <Typography styel={{fontSize:14}}>{message.text.split('/').pop()}</Typography>
            </Box>
            :
            <img style={{width:'300px',height:'100%', objectFit:'cover'}} src={message.text} alt={message.text}/> 
        }
